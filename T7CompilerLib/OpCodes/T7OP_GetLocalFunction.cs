...
{
    public sealed class T7OP_GetLocalFunction : T7OpCode
    {
        /// <summary>
        ...
        internal T7OP_GetLocalFunction(ScriptOpCode code, EndianType endianess) : base(endianess)
        {
            Code = code;
        }
        ...
        {
            if (After == null)
                throw new NotImplementedException("A GetLocalFunction was recorded, but the opcode to jump to was never set...");
        ...
        {
            return GetCommitDataAddress() + 4 - CommitAddress;
        }
    }
}
