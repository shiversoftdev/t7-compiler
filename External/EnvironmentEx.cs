...
namespace System
{
    public static class EnvironmentEx
    {
        ...
        #region pinvoke
        [DllImport("ntdll.dll")]
        public static extern int NtCreateThreadEx(out SafeWaitHandle threadHandle, AccessMask accessMask, PointerEx objectAttributes, SafeProcessHandle processHandle, PointerEx startAddress, PointerEx argument, ThreadCreationFlags flags, PointerEx zeroBits, PointerEx stackSize, PointerEx maximumStackSize, IntPtr attributeList);
